...
const SchoolUi = ({data}) => {
    return (
        <div className="flex flex-col items-center gap-4 md:flex-row lg:gap-6 shadow-sm">
            ...
            <div className="flex flex-col gap-2">
                ...
                <h2 className="text-xl font-bold text-gray-800">
                    <a href="#" className="transition duration-100 hover:text-rose-500 active:text-rose-600">{data.title}</a>
                </h2>
